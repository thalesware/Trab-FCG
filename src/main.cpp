...
int main(int argc, char* argv[])
{
    ...
    GLFWwindow* window;
    window = glfwCreateWindow(800, 600, "FCG Tactics", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        float x1 = stage1.tilesArray[selectedTile].origin_shift_x;
        float y1 = stage1.tilesArray[selectedTile].origin_shift_y;
        float z1 = stage1.tilesArray[selectedTile].origin_shift_z;

        // Abaixo definimos as varáveis que efetivamente definem a câmera virtual.
        // Veja slides 195-227 e 229-234 do documento Aula_08_Sistemas_de_Coordenadas.pdf.
        glm::vec4 camera_position_c  = glm::vec4(x+x1,y+y1,z+z1,1.0f); // Ponto "c", centro da câmera
        glm::vec4 camera_lookat_l    = glm::vec4(x1,y1,z1,1.0f); // Ponto "l", para onde a câmera (look-at) estará sempre olhando
...
Stage stage1Creation(){ //x cresce = vai para direita, z cresce = vai para baixo
    ...
    //printf("%d",currentLastTileId);
    stage1lastID = currentLastTileId;
